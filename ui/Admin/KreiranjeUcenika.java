...
public class KreiranjeUcenika extends JFrame{
	...
	private String godine[] = {
			"-", "2003", "2004", "2005", "2005", "2006", "2007", "2008", "2009", "2010", "2011", "2012", "2013", "2014"
	};
	...
	KreiranjeUcenika(){
		...
		btnNewButton.addActionListener(new ActionListener() {
			...
			if(bul||jedinstvenost) {
				al.Greska();
			}
			if((bul||jedinstvenost) == false) {
				Ucenik ucenik = new Ucenik(tfime, tfprezime, tfid, dan, mesec, godina, pol, Razred, godinaUpisa, tfemail, tfsifra);
