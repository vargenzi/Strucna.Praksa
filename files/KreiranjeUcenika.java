...
public class KreiranjeUcenika extends JFrame{
	...
	KreiranjeUcenika(){
		...
		JLabel lblNewLabel_1_1_2 = new JLabel("GODINA RO\u0110ENJA:");
	...
	public void Cuvanje(Ucenici ucenik) throws IOException {
		...
		bw.write(ucenik.ime + "/" + ucenik.prezime + "/" +ucenik.jmbg + "/"+ ucenik.email +"/"+ ucenik.sifra+ "/" + ucenik.dan_rodjenja + "/" + ucenik.mesec_rodjenja + "/" + ucenik.godina_rodjenja + "/" + ucenik.godina_upisa + "/" + ucenik.razred + "/" + ucenik.pol + "\n");
	...
	public boolean ProveraJedinstvenosti(String jmbg) throws IOException {
		...
		br = new BufferedReader(new FileReader("C:\\Users\\REPIC\\Desktop\\esdnevnik\\src\\esdnevnik\\podaci\\Podaci_o_ucenicima.txt"));
		String linije;
		String vrednosti = "";
		while((linije = br.readLine()) != null){
			
			String pomocni[] = linije.split("/", 100);
			if(pomocni[2].equals(jmbg)) {
