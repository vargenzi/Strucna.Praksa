...
public class BrisanjeUcenika extends JFrame{
	...
	ArrayList<String[]> alu = new ArrayList<String[]>();
		...
		btnSauvaj.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Brisanje2();
					int i = 0;
					int j = PretragaOcena(textField.getText());
					while(i<j) {
						
						Brisanje(textField.getText());
...
public int PretragaOcena(String jmbg) {
	int i = 0;
	int k = 0;
	while(i<alu.size()) {
		if(jmbg.equals(alu.get(i)[1])) {
			k++;
		}
...
public void BrisanjeOcena() throws IOException {
	...
	while(i<alu.size()) {
		...
		bw.write(alu.get(i)[0] + "/" + alu.get(i)[1] + "/" + alu.get(i)[2] + "/" + alu.get(i)[3] + "/" + alu.get(i)[4] + "/" + alu.get(i)[5]);
		bw.newLine();
...
public void Brisanje(String jmbg) {
	int i = 0;
	while(i<alu.size()) {
		if(alu.get(i)[1].equals(jmbg)) {
			alu.remove(i);
			return;
		}
